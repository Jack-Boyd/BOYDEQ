...
void BOYDEQAudioProcessorEditor::parameterValueChanged(int parameterIndex, float newValue)
{
    parametersChanged.set(true);
}
void BOYDEQAudioProcessorEditor::timerCallback()
{
...
std::vector<juce::Component*> BOYDEQAudioProcessorEditor::getComps()
{
    return
    {
        &peakFreqSlider,
