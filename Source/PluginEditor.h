...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<BOYDEQAudioProcessor::BlockType>& scsf) : leftChannelFifo(&scsf)
    {
...
private:
    SingleChannelSampleFifo<BOYDEQAudioProcessor::BlockType>* leftChannelFifo;
